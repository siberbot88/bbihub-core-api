...
<div class="w-full px-6 py-3 flex items-center justify-between gap-3 bg-white">
  {{-- Search --}}
  <div class="relative flex-1">
   <span class="absolute inset-y-0 left-3 flex items-center text-gray-400">
    ...
    <button class="absolute right-1 top-1/2 -translate-y-1/2 rounded-full bg-red-600 px-4 py-1.5 text-sm font-semibold text-white shadow hover:bg-rose-700">Search</button>
  </div>

  {{-- Right icons --}}
  <div class="ml-2 flex items-center gap-2">
    <button class="rounded-full p-2 text-gray-500 hover:bg-gray-50 hover:text-gray-700" title="Notifikasi">
      <svg xmlns="{{ asset('icons/notif.svg') }}" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5"><path d="M14.25 18.5a2.25 2.25 0 1 1-4.5 0h4.5Z"/><path d="M5 10.75a7 7 0 1 1 14 0v3.318l1.106 1.658A1 1 0 0 1 19.25 17H4.75a1 1 0 0 1-.856-1.574L5 14.068v-3.318Z"/></svg>
    </button>
